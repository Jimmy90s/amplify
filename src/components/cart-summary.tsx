...
export function CartSummary() {
  ...
  return (
    <section
      ...
      className="mt-16 rounded-lg border-2 border-gray-200 bg-gray-50 px-4 py-6 shadow-md dark:border-gray-900 dark:bg-black dark:text-white sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8"
    >
